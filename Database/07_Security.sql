...
GRANT SELECT ON dbo.vw_materials TO role_participant;
...
GRANT EXECUTE ON dbo.usp_update_section_visit_feedback TO role_participant;
GO

GRANT SELECT ON dbo.vw_reports_with_authors TO role_reviewer;
GRANT SELECT ON dbo.vw_review_results TO role_reviewer;
GRANT SELECT ON dbo.vw_materials TO role_reviewer;
...
GRANT SELECT ON dbo.vw_materials TO role_organizer;
GRANT SELECT ON dbo.vw_section_visit_feedback TO role_organizer;
...
GRANT EXECUTE ON dbo.usp_update_section_visit_feedback TO role_organizer;
GRANT EXECUTE ON dbo.usp_add_material TO role_organizer;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON dbo.tb_materials TO role_admin;
...
GRANT SELECT ON dbo.vw_materials TO role_admin;
GRANT SELECT ON dbo.vw_section_visit_feedback TO role_admin;
...
GRANT EXECUTE ON dbo.usp_update_section_visit_feedback TO role_admin;
GRANT EXECUTE ON dbo.usp_add_material TO role_admin;
